...
<div class="container" style="margin-top:150px;margin-bottom:600px;background: #30df0517;border-radius: 7px;height: 500px; border:12px solid #377f00;">
    <h2>MY CART</h2>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <h3 style="font-family:cursive;">Grand Total :<span><?php echo $grand_total?>/</span></h3>
        </div>
    </div>
    <div class="col-md-4">
    <div class="checkout_btn d-flex justify-content-center">
