...
<div class="container" style="margin-top: 150px;margin-bottom: 500px;background:#06396c40;padding:30px;border-radius:6px; border:12px solid #377f00;background: #30df0517;border-radius: 7px;">
    <h2>Please</h2>
    <div class="row">
    <div class="col-md-8">
    <h3>Give your billing information to checkout</h3>
    <form action="process_checkout.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-4" style="background:#ff5200cf;padding:30px;border-radius:6px;">
            <h3>ORDER SUMMERY</h3>
